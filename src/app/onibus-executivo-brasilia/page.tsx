...
const USE_CASES = [
  {
    label: "Grandes eventos e congressos",
    desc: "Logística de deslocamento para grandes volumes de participantes e convidados.",
  },
  {
    label: "Transporte corporativo",
    desc: "Transporte de equipes, colaboradores e delegações com organização e pontualidade.",
  },
  {
    label: "Transfer aeroporto em grupo",
    desc: "Traslado coordenado para grandes grupos no Aeroporto de Brasília.",
  },
  {
    label: "Excursões e roteiros",
    desc: "Deslocamentos planejados para grandes grupos com conforto e segurança.",
  },
  {
    label: "Formaturas e cerimônias",
    desc: "Transporte organizado para grandes comitivas e convidados.",
  },
  {
    label: "Operações especiais",
    desc: "Deslocamentos de grande porte sob demanda para qualquer necessidade.",
  },
];
...
const FAQ_ITEMS = [
  {
    question: "O ônibus executivo inclui motorista?",
  ...
  },
  {
    ...
    answer: "Sim. Atendemos eventos corporativos, congressos, feiras e qualquer operação que precise de logística de transporte para grandes grupos.",
  },
  {
    question: "Fazem transfer em grupo para o Aeroporto de Brasília?",
    answer: "Sim. Coordenamos o transporte de grandes grupos com planejamento de horário para embarques e desembarques.",
  },
  {
    question: "É possível contratar mais de um ônibus para o mesmo evento?",
    answer: "Sim. Atendemos operações de maior escala com múltiplos veículos coordenados. Informe a demanda total no WhatsApp.",
  },
  {
...
export default function OnibusExecutivoBrasiliaPage() {
  return (
    <>
      <Header />
      <main>
        ...
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden bg-navy-950">
          ...
          <div className="relative z-10 container-st py-20 lg:py-28">
            ...
            <p className="mt-5 text-base sm:text-lg leading-relaxed text-white/70 max-w-2xl">
              Ônibus executivo para grandes grupos, eventos, congressos e transporte corporativo.
            ...
            <p className="mt-3 text-xs text-white/35">
              Orçamento rápido · Atendimento para grandes grupos e empresas
            </p>
          </div>
        </section>
          ...
          <div className="container-st">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-[22px] sm:text-[28px] font-bold text-navy-950 leading-snug mb-4">
                O que é ônibus executivo com motorista?
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <h2 className="text-[24px] sm:text-[32px] font-bold text-navy-950 leading-snug mb-4">
                  Ônibus executivo com tudo incluído
                </h2>
                <p className="text-sm sm:text-base leading-relaxed text-gray-600 mb-6">
                  Veículos de grande capacidade para grupos numerosos, com motorista profissional
                  e espaço para bagagens de todos os passageiros.
                </p>
        ...
        <section className="section-padding bg-surface-off">
          <div className="container-st">
            <SectionHeader
              eyebrow="Atendimento"
              title="Para quem é o ônibus executivo?"
        ...
        <section id="como-funciona" className="section-padding bg-surface-white">
          <div className="container-st">
            <SectionHeader
              eyebrow="Processo"
              title="Como contratar o ônibus executivo"
        ...
        <section className="section-padding bg-surface-off">
          <div className="container-st">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-[22px] sm:text-[28px] font-bold text-navy-950 leading-snug mb-4">
                Ônibus executivo em toda Brasília e DF
              </h2>
