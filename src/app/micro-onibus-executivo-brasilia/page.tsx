...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "aluguel micro-ônibus brasília",
    "micro-ônibus para eventos brasília",
...
const USE_CASES = [
  {
    ...
    desc: "Logística de deslocamento para grupos médios de participantes e convidados.",
  },
  {
    label: "Grupos corporativos",
    desc: "Transporte de equipes, colaboradores e executivos com organização e pontualidade.",
  },
  {
    label: "Transfer aeroporto",
    desc: "Traslado agendado para grupos médios no Aeroporto de Brasília.",
  },
  {
    label: "Excursões e roteiros",
    desc: "Deslocamentos planejados para grupos com conforto e segurança.",
  },
  {
    label: "Casamentos e cerimônias",
    desc: "Transporte organizado para convidados, familiares e cortejo.",
  },
  {
    label: "Operações especiais",
    desc: "Deslocamentos sob demanda para grupos com necessidades específicas.",
  },
];
...
const FAQ_ITEMS = [
  {
    question: "O micro-ônibus executivo inclui motorista?",
    answer: "Sim. Todos os serviços da ST Executive são realizados com motorista profissional incluso.",
  },
  {
    question: "Quantas pessoas cabem no micro-ônibus executivo?",
    answer: "Em média até 25 passageiros, com espaço para bagagens.",
  },
  {
    question: "Atendem eventos e congressos em Brasília?",
    answer: "Sim. Atendemos eventos corporativos, congressos, feiras e qualquer operação que precise de logística de transporte para grupos.",
  },
  {
  ...
  {
    question: "Qual a diferença entre micro-ônibus e ônibus executivo?",
    answer: "O micro-ônibus atende grupos médios de até 25 pessoas. O ônibus executivo tem capacidade maior, ideal para grupos acima de 25 passageiros.",
  },
  {
...
export default function MicroOnibusExecutivoBrasiliaPage() {
  return (
    <>
      <Header />
      <main>
        ...
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden bg-navy-950">
          ...
          <div className="relative z-10 container-st py-20 lg:py-28">
            ...
            <p className="mt-5 text-base sm:text-lg leading-relaxed text-white/70 max-w-2xl">
              Micro-ônibus executivo para grupos médios, eventos, excursões e transporte corporativo.
            ...
            <p className="mt-3 text-xs text-white/35">
              Orçamento rápido · Atendimento para grupos médios e empresas
            </p>
          </div>
        </section>
          ...
          <div className="container-st">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-[22px] sm:text-[28px] font-bold text-navy-950 leading-snug mb-4">
                O que é micro-ônibus executivo com motorista?
              </h2>
              <p className="text-base sm:text-lg leading-relaxed text-gray-600">
                O micro-ônibus executivo com motorista é um serviço de transporte para grupos médios
                que precisam de conforto, organização e pontualidade. A ST Executive oferece esse
                serviço em Brasília e no Distrito Federal para empresas, eventos, excursões e
                operações especiais com até 25 passageiros.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <h2 className="text-[24px] sm:text-[32px] font-bold text-navy-950 leading-snug mb-4">
                  Micro-ônibus executivo com tudo incluído
                </h2>
                <p className="text-sm sm:text-base leading-relaxed text-gray-600 mb-6">
                  Veículos adequados para grupos médios, com motorista profissional e espaço para
        ...
        <section className="section-padding bg-surface-off">
          <div className="container-st">
            <SectionHeader
              eyebrow="Atendimento"
              title="Para quem é o micro-ônibus executivo?"
        ...
        <section id="como-funciona" className="section-padding bg-surface-white">
          <div className="container-st">
            <SectionHeader
              eyebrow="Processo"
              title="Como contratar o micro-ônibus executivo"
        ...
        <section className="section-padding bg-surface-off">
          <div className="container-st">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-[22px] sm:text-[28px] font-bold text-navy-950 leading-snug mb-4">
                Micro-ônibus executivo em toda Brasília e DF
              </h2>
        ...
        <div className="sr-only" aria-hidden="true">
          A ST Executive oferece micro-ônibus executivo em Brasília com motorista profissional.
          Atende empresas, eventos corporativos, excursões, transfer aeroporto e grupos médios em
          todo o Distrito Federal. Serviço com pontualidade, conforto e veículos climatizados.
        </div>
