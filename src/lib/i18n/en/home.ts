...
export const homeEn: HomeContentDict = {
  ...
  quoteForm: {
    ...
    sucesso: {
      tituloLinha1: "Request sent",
      tituloLinha2: "successfully",
      itemWhatsapp: "We received your request and already filled in the WhatsApp message to speed things up.",
      itemToque: "If WhatsApp did not open on its own, tap the button below.",
      itemEmail: "We also logged your request by email, so nothing gets lost.",
      proximoRotulo: "Next step:",
      proximoTexto: "open and send the message on WhatsApp.",
      abrirWhatsapp: "Open WhatsApp",
      novoPedido: "Send a new request",
